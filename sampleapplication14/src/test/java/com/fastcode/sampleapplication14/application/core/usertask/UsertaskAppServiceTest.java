...
import com.fastcode.sampleapplication14.domain.core.usertask.*;
...
import com.fastcode.sampleapplication14.domain.core.usertask.QUsertask;
...
import com.fastcode.sampleapplication14.domain.core.authorization.users.IUsersRepository;
...
public class UsertaskAppServiceTest {
	...
	public void findUsertaskById_IdIsNotNullAndIdExists_ReturnUsertask() {
	    ...
	    Assertions.assertThat(_appService.findById(usertaskId)).isEqualTo(_mapper.usertaskToFindUsertaskByIdOutput(usertask));
	}
    ...
    public void createUsertask_UsertaskIsNotNullAndUsertaskDoesNotExist_StoreUsertask() { 
        ...
        Mockito.when(_usertaskRepository.save(any(Usertask.class))).thenReturn(usertaskEntity);
	   	...
	   	Assertions.assertThat(_appService.create(usertaskInput)).isEqualTo(_mapper.usertaskToCreateUsertaskOutput(usertaskEntity));
	...
	public void createUsertask_UsertaskIsNotNullAndUsertaskDoesNotExistAndChildIsNullAndChildIsNotMandatory_StoreUsertask() {
	    ...
	    Assertions.assertThat(_appService.create(usertaskInput)).isEqualTo(_mapper.usertaskToCreateUsertaskOutput(usertask)); 
	}
	...
	public void updateUsertask_UsertaskIsNotNullAndUsertaskDoesNotExistAndChildIsNullAndChildIsNotMandatory_ReturnUpdatedUsertask() {
		...
		Mockito.when(_usertaskRepository.save(any(Usertask.class))).thenReturn(usertask);
		Assertions.assertThat(_appService.update(usertaskId,usertaskInput)).isEqualTo(_mapper.usertaskToUpdateUsertaskOutput(usertask));
	}
	...
	public void updateUsertask_UsertaskIdIsNotNullAndIdExists_ReturnUpdatedUsertask() {
		...
		Mockito.when(_usertaskRepository.save(any(Usertask.class))).thenReturn(usertaskEntity);
		Assertions.assertThat(_appService.update(usertaskId,usertask)).isEqualTo(_mapper.usertaskToUpdateUsertaskOutput(usertaskEntity));
	}
	...
	public void search_SearchIsNotNullAndSearchContainsCaseThree_ReturnBooleanBuilder() throws Exception {
		...
		Mockito.doReturn(builder).when(_appService).searchKeyValuePair(any(QUsertask.class), any(HashMap.class), any(HashMap.class));
	...
	public void GetTask_IfUsertaskIdAndTaskIdIsNotNullAndUsertaskExists_ReturnTask() {
		...
		Assertions.assertThat(_appService.getTask(usertaskId)).isEqualTo(_mapper.taskToGetTaskOutput(taskEntity, usertask));
	}
	...
	public void GetUsers_IfUsertaskIdAndUsersIdIsNotNullAndUsertaskExists_ReturnUsers() {
		...
		Assertions.assertThat(_appService.getUsers(usertaskId)).isEqualTo(_mapper.usersToGetUsersOutput(usersEntity, usertask));
	}
