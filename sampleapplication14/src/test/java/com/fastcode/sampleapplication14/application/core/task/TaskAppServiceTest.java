...
import com.fastcode.sampleapplication14.domain.core.task.*;
...
public class TaskAppServiceTest {
	...
	public void search_SearchIsNotNullAndSearchContainsCaseThree_ReturnBooleanBuilder() throws Exception {
		...
		Mockito.doReturn(builder).when(_appService).searchKeyValuePair(any(QTask.class), any(HashMap.class), any(HashMap.class));
	...
	public void GetProject_IfTaskIdAndProjectIdIsNotNullAndTaskExists_ReturnProject() {
		...
		Assertions.assertThat(_appService.getProject(ID)).isEqualTo(_mapper.projectToGetProjectOutput(projectEntity, task));
	}
