...
import com.fastcode.sampleapplication14.domain.core.timesheetstatus.*;
...
import com.fastcode.sampleapplication14.domain.core.timesheetstatus.QTimesheetstatus;
...
public class TimesheetstatusAppServiceTest {
	...
	public void findTimesheetstatusById_IdIsNotNullAndIdExists_ReturnTimesheetstatus() {
	    ...
	    Assertions.assertThat(_appService.findById(ID )).isEqualTo(_mapper.timesheetstatusToFindTimesheetstatusByIdOutput(timesheetstatus));
	}
    ...
    public void createTimesheetstatus_TimesheetstatusIsNotNullAndTimesheetstatusDoesNotExist_StoreTimesheetstatus() { 
        ...
        Mockito.when(_mapper.createTimesheetstatusInputToTimesheetstatus(any(CreateTimesheetstatusInput.class))).thenReturn(timesheetstatusEntity); 
        Mockito.when(_timesheetstatusRepository.save(any(Timesheetstatus.class))).thenReturn(timesheetstatusEntity);

	   	Assertions.assertThat(_appService.create(timesheetstatusInput)).isEqualTo(_mapper.timesheetstatusToCreateTimesheetstatusOutput(timesheetstatusEntity));
	...
	public void updateTimesheetstatus_TimesheetstatusIdIsNotNullAndIdExists_ReturnUpdatedTimesheetstatus() {
		...
		Mockito.when(_mapper.updateTimesheetstatusInputToTimesheetstatus(any(UpdateTimesheetstatusInput.class))).thenReturn(timesheetstatusEntity);
		Mockito.when(_timesheetstatusRepository.save(any(Timesheetstatus.class))).thenReturn(timesheetstatusEntity);
		Assertions.assertThat(_appService.update(ID,timesheetstatus)).isEqualTo(_mapper.timesheetstatusToUpdateTimesheetstatusOutput(timesheetstatusEntity));
	}
	...
	public void search_SearchIsNotNullAndSearchContainsCaseThree_ReturnBooleanBuilder() throws Exception {
		...
		Mockito.doReturn(builder).when(_appService).searchKeyValuePair(any(QTimesheetstatus.class), any(HashMap.class), any(HashMap.class));
