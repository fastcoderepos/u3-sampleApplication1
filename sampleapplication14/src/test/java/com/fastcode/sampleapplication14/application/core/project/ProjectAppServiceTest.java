package com.fastcode.sampleapplication14.application.core.project;
...
import com.fastcode.sampleapplication14.domain.core.project.*;
import com.fastcode.sampleapplication14.commons.search.*;
import com.fastcode.sampleapplication14.application.core.project.dto.*;
import com.fastcode.sampleapplication14.domain.core.project.QProject;
...
public class ProjectAppServiceTest {
    ...
    public void createProject_ProjectIsNotNullAndProjectDoesNotExist_StoreProject() { 
        ...
        Mockito.when(_projectRepository.save(any(Project.class))).thenReturn(projectEntity);
	   	...
	   	Assertions.assertThat(_appService.create(projectInput)).isEqualTo(_mapper.projectToCreateProjectOutput(projectEntity));
	...
	public void updateProject_ProjectIdIsNotNullAndIdExists_ReturnUpdatedProject() {
		...
		Mockito.when(_projectRepository.save(any(Project.class))).thenReturn(projectEntity);
		Assertions.assertThat(_appService.update(ID,project)).isEqualTo(_mapper.projectToUpdateProjectOutput(projectEntity));
	}
	...
	public void search_SearchIsNotNullAndSearchContainsCaseThree_ReturnBooleanBuilder() throws Exception {
		...
		Mockito.doReturn(builder).when(_appService).searchKeyValuePair(any(QProject.class), any(HashMap.class), any(HashMap.class));
	...
	public void GetCustomer_IfProjectIdAndCustomerIdIsNotNullAndProjectExists_ReturnCustomer() {
		...
		Assertions.assertThat(_appService.getCustomer(ID)).isEqualTo(_mapper.customerToGetCustomerOutput(customerEntity, project));
	}
