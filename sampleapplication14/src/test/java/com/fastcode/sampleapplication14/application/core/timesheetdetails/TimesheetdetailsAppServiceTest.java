package com.fastcode.sampleapplication14.application.core.timesheetdetails;
...
import com.fastcode.sampleapplication14.domain.core.timesheetdetails.*;
import com.fastcode.sampleapplication14.commons.search.*;
import com.fastcode.sampleapplication14.application.core.timesheetdetails.dto.*;
import com.fastcode.sampleapplication14.domain.core.timesheetdetails.QTimesheetdetails;
import com.fastcode.sampleapplication14.domain.core.timesheetdetails.Timesheetdetails;
import com.fastcode.sampleapplication14.domain.core.task.Task;
import com.fastcode.sampleapplication14.domain.core.task.ITaskRepository;
import com.fastcode.sampleapplication14.domain.core.timeofftype.Timeofftype;
import com.fastcode.sampleapplication14.domain.core.timeofftype.ITimeofftypeRepository;
import com.fastcode.sampleapplication14.domain.core.timesheet.Timesheet;
import com.fastcode.sampleapplication14.domain.core.timesheet.ITimesheetRepository;
...
public class TimesheetdetailsAppServiceTest {
	...
	public void findTimesheetdetailsById_IdIsNotNullAndIdExists_ReturnTimesheetdetails() {
	    ...
	    Assertions.assertThat(_appService.findById(ID )).isEqualTo(_mapper.timesheetdetailsToFindTimesheetdetailsByIdOutput(timesheetdetails));
	}
    ...
    public void createTimesheetdetails_TimesheetdetailsIsNotNullAndTimesheetdetailsDoesNotExist_StoreTimesheetdetails() { 
        ...
        Mockito.when(_mapper.createTimesheetdetailsInputToTimesheetdetails(any(CreateTimesheetdetailsInput.class))).thenReturn(timesheetdetailsEntity); 
        Mockito.when(_timesheetdetailsRepository.save(any(Timesheetdetails.class))).thenReturn(timesheetdetailsEntity);

	   	Assertions.assertThat(_appService.create(timesheetdetailsInput)).isEqualTo(_mapper.timesheetdetailsToCreateTimesheetdetailsOutput(timesheetdetailsEntity));
	...
	public void createTimesheetdetails_TimesheetdetailsIsNotNullAndTimesheetdetailsDoesNotExistAndChildIsNullAndChildIsNotMandatory_StoreTimesheetdetails() {
		...
		Mockito.when(_mapper.createTimesheetdetailsInputToTimesheetdetails(any(CreateTimesheetdetailsInput.class))).thenReturn(timesheetdetails);
		Mockito.when(_timesheetdetailsRepository.save(any(Timesheetdetails.class))).thenReturn(timesheetdetails);
	    Assertions.assertThat(_appService.create(timesheetdetailsInput)).isEqualTo(_mapper.timesheetdetailsToCreateTimesheetdetailsOutput(timesheetdetails)); 
	}
	...
	public void updateTimesheetdetails_TimesheetdetailsIsNotNullAndTimesheetdetailsDoesNotExistAndChildIsNullAndChildIsNotMandatory_ReturnUpdatedTimesheetdetails() {
		...
		Mockito.when(_mapper.updateTimesheetdetailsInputToTimesheetdetails(any(UpdateTimesheetdetailsInput.class))).thenReturn(timesheetdetails);
		Mockito.when(_timesheetdetailsRepository.save(any(Timesheetdetails.class))).thenReturn(timesheetdetails);
		Assertions.assertThat(_appService.update(ID,timesheetdetailsInput)).isEqualTo(_mapper.timesheetdetailsToUpdateTimesheetdetailsOutput(timesheetdetails));
	}
	...
	public void updateTimesheetdetails_TimesheetdetailsIdIsNotNullAndIdExists_ReturnUpdatedTimesheetdetails() {
		...
		Mockito.when(_mapper.updateTimesheetdetailsInputToTimesheetdetails(any(UpdateTimesheetdetailsInput.class))).thenReturn(timesheetdetailsEntity);
		Mockito.when(_timesheetdetailsRepository.save(any(Timesheetdetails.class))).thenReturn(timesheetdetailsEntity);
		Assertions.assertThat(_appService.update(ID,timesheetdetails)).isEqualTo(_mapper.timesheetdetailsToUpdateTimesheetdetailsOutput(timesheetdetailsEntity));
	}
	...
	public void search_SearchIsNotNullAndSearchContainsCaseThree_ReturnBooleanBuilder() throws Exception {
		...
		Mockito.doReturn(builder).when(_appService).searchKeyValuePair(any(QTimesheetdetails.class), any(HashMap.class), any(HashMap.class));
	...
	public void GetTask_IfTimesheetdetailsIdAndTaskIdIsNotNullAndTimesheetdetailsExists_ReturnTask() {
		...
		Assertions.assertThat(_appService.getTask(ID)).isEqualTo(_mapper.taskToGetTaskOutput(taskEntity, timesheetdetails));
	}
	...
	public void GetTimeofftype_IfTimesheetdetailsIdAndTimeofftypeIdIsNotNullAndTimesheetdetailsExists_ReturnTimeofftype() {
		...
		Assertions.assertThat(_appService.getTimeofftype(ID)).isEqualTo(_mapper.timeofftypeToGetTimeofftypeOutput(timeofftypeEntity, timesheetdetails));
	}
	...
	public void GetTimesheet_IfTimesheetdetailsIdAndTimesheetIdIsNotNullAndTimesheetdetailsExists_ReturnTimesheet() {
		...
		Assertions.assertThat(_appService.getTimesheet(ID)).isEqualTo(_mapper.timesheetToGetTimesheetOutput(timesheetEntity, timesheetdetails));
	}
